...
# this code is used for extracting data from word2vec file and as such is not needed for the
# cnn to run as all of that data has already been saved to mapping.csv and vectors.npy
...
# this code is used for extracting data from processed word2vec that is then used for CNN
